...
export const PropertyCard = ({ property, viewMode }: { property: any; viewMode: string }) => {
      ...
      <div className="p-5 flex-1 flex flex-col justify-between">
        <div>
          ...
          <div className="flex items-center gap-1 text-[#8e8b86] text-[11px] mt-1 font-light">
             <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>
             {property.location}
          </div>
        </div>
        ...
        <div className="mt-4">
          ...
          <div className="flex gap-4 text-[#4a4845] text-[11px]">
            <span className="flex items-center gap-1.5"><strong className="text-[#b89a5a]">●</strong> {property.beds} Beds</span>
            <span className="flex items-center gap-1.5"><strong className="text-[#b89a5a]">●</strong> {property.baths} Baths</span>
            <span className="flex items-center gap-1.5"><strong className="text-[#b89a5a]">●</strong> {property.area} m²</span>
          </div>
        </div>
      </div>
    </div>
